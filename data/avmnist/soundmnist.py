...
class SoundMNIST(torch.utils.data.Dataset):
	...
	def __getitem__(self, index):
		...
		assert image_label==sound_label		# 이미지 클래스와 오디오 클래스가 동일한가요?
...
if __name__ == '__main__':
	...
	dir = '/home/etri01/jy/harmonicnas/Harmonic-NAS/soundmnist/'
	img_root = dir+'mnist/'
	...
	print(batch[0].shape)		# [batch_size, channel, height, width]
	print(batch[1].shape)		# [batch_size, channel, n_mfcc, time_steps]
