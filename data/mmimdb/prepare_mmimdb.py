...
dataset_h5 = h5py.File('/home/etri01/jy/harmonicnas/Harmonic-NAS/MM_IMDB/multimodal_imdb.hdf5', 'r')

dataset_len = dataset_h5['features'].shape[0]

# save_dir = "/home/mghebriout/datasets/MM-IMDB/Pre_processed/"
save_dir = "/home/etri01/jy/harmonicnas/Harmonic-NAS/MM_IMDB/Pre_processed"


# split_file = open('./data/mmimdb/mmimdb_split.json', 'r')
split_file = open('/home/etri01/jy/harmonicnas/Harmonic-NAS/data/mmimdb/mmimdb_split.json', 'r')
